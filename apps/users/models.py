...
class EmailVerifyRecord(models.Model):
    code = models.CharField(max_length=20, verbose_name=r'验证码')
    email = models.EmailField(max_length=50, verbose_name=r'邮箱')
    send_type = models.CharField(choices=(('register',u"注册"), ("forget",u"忘记密码"),("update_email",u"修改邮箱")),max_length=30)
